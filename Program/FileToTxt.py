...
print('All the files in the directory would be converted to txt')
print() 
print()
...
#De que otra manera estructura usted su narrativa en funcion del tiempo y la ejecucion de sus pasos
#Que otra forma existe de coordinar el fundamento narrativo que se solicita.
#Cual es la interaccion que buscamos nosotros entender.

#Que propiedad yo puedo establecer sobre la realidad como yo puedo coordinar propiedades mas especificas
#Que conciencia yo puedo establecer ahora mismo.